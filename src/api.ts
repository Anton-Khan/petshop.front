...
export const getBalance = () => instance.get(`/salling/balance`).then(result => result.data);
export const getCartPets = () => instance.get(`/cart`).then(result => result.data);
export const getCost = () => instance.get(`/salling/cost`).then(result => result.data);
...
export const buyPets = () => instance.post(`/salling`);